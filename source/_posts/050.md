...
![01](https://cdn.itbob.cn/img/article/050/01.png)
...
![02](https://cdn.itbob.cn/img/article/050/02.png)
...
![03](https://cdn.itbob.cn/img/article/050/03.png)

那么我们直接大胆猜测一下，是不是就是某个数据经过 MD5 之后就是 `_signature` 了呢？再继续调试一下，注意 `arguments` 的变化：

![04](https://cdn.itbob.cn/img/article/050/04.png)
...
![05](https://cdn.itbob.cn/img/article/050/05.png)

我们前面猜测是 MD5，直接验证一下，发现并不是的，即便是同一个时间戳，经过 `window.byted_acrawler()` 后得到的值每次也都不一样：

![06](https://cdn.itbob.cn/img/article/050/06.png)
...
![07](https://cdn.itbob.cn/img/article/050/07.png)
...
![08](https://cdn.itbob.cn/img/article/050/08.png)

![09](https://cdn.itbob.cn/img/article/050/09.png)

与默认参数进行对比，可以发现 `md5_hh()` 里有两个默认参数被修改了：

![10](https://cdn.itbob.cn/img/article/050/10.png)
...
![11](https://cdn.itbob.cn/img/article/050/11.png)
...
![12](https://cdn.itbob.cn/img/article/050/12.png)

![13](https://cdn.itbob.cn/img/article/050/13.png)

![14](https://cdn.itbob.cn/img/article/050/14.png)
...
![15](https://cdn.itbob.cn/img/article/050/15.png)

下一步，sign 方法，取时间戳：

![16](https://cdn.itbob.cn/img/article/050/16.png)

下一步，调用 `hex_md5()` 方法：

![17](https://cdn.itbob.cn/img/article/050/17.png)

从这里就可以开始本地同步调试了，本地 MD5 下断点调试，可以看到得到的值不一样：

![18](https://cdn.itbob.cn/img/article/050/18.png)

下一步，调用 `str2binl()` 方法，和本地得到的值是一样的：

![19](https://cdn.itbob.cn/img/article/050/19.png)

![20](https://cdn.itbob.cn/img/article/050/20.png)

下一步，调用 `core_md5()` 方法，得到的值和本地就不一样了，这里大致可以确定此方法内部与标准算法有差别了：

![21](https://cdn.itbob.cn/img/article/050/21.png)

![22](https://cdn.itbob.cn/img/article/050/22.png)

下一步，调用 `md5_ff()` 方法，得到的值是一样的：

![23](https://cdn.itbob.cn/img/article/050/23.png)

![24](https://cdn.itbob.cn/img/article/050/24.png)

以此类推，最终会找到两个不一样的地方，即 `md5_hh()` 两个默认参数被修改了。

`-722521979` 被改成了 `-722521939`：

![25](https://cdn.itbob.cn/img/article/050/25.png)

![26](https://cdn.itbob.cn/img/article/050/26.png)

`76029189` 被改成了 `76029185`：

![27](https://cdn.itbob.cn/img/article/050/27.png)

![28](https://cdn.itbob.cn/img/article/050/28.png)

最终提交结果，验证成功：

![29](https://cdn.itbob.cn/img/article/050/29.png)
