...
tags: 
    ...
    - 爬虫
categories: JS 逆向实战
feature: https://cdn.itbob.cn/img/thumbnail/defense4.png
---
...
![01.png](https://cdn.itbob.cn/img/article/046/01.png)
...
![02.png](https://cdn.itbob.cn/img/article/046/02.png)
...
![03.png](https://cdn.itbob.cn/img/article/046/03.png)
...
![04.png](https://cdn.itbob.cn/img/article/046/04.png)

通过搜索可以发现如下可疑代码片段：

![05.png](https://cdn.itbob.cn/img/article/046/05.png)
...
![06.png](https://cdn.itbob.cn/img/article/046/06.png)
...
![07.png](https://cdn.itbob.cn/img/article/046/07.png)

然后修改 m3u8 文件里 key 的地址、名称，建议将 key、m3u8、ts 文件都放同一个文件夹，这样 m3u8 文件里就不用添加资源路径了，不容易出错。

![08.png](https://cdn.itbob.cn/img/article/046/08.png)

然后在当前文件夹，打开命令行输入命令：`ffmpeg -allowed_extensions ALL -i live.m3u8 -c copy live.mp4`，即可自动解密 ts，并合并转换为 .mp4 格式：

![09.png](https://cdn.itbob.cn/img/article/046/09.png)

![10.png](https://cdn.itbob.cn/img/article/046/10.png)
...
![11.png](https://cdn.itbob.cn/img/article/046/11.png)

也可以选择其他 - 工具 - 合并助手，添加所有 TS 文件，输入 key 后自动处理：

![12.png](https://cdn.itbob.cn/img/article/046/12.png)

处理完毕后的 mp4 文件默认在软件目录的 output 文件夹里面，解密后是一段动画，往后看会找到 flag：`flag{like_sub_52tube}` 为正确答案。

![13.png](https://cdn.itbob.cn/img/article/046/13.png)

![14.png](https://cdn.itbob.cn/img/article/046/14.png)

![15.png](https://cdn.itbob.cn/img/article/046/15.png)
