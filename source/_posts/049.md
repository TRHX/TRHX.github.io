...
tags: 
    ...
    - 爬虫
categories: JS 逆向实战
feature: https://cdn.itbob.cn/img/thumbnail/defense3.png
...
![01](https://cdn.itbob.cn/img/article/049/01.png)

![02](https://cdn.itbob.cn/img/article/049/02.png)

异常 IP，登录账号后再请求，Header 以及 Cookies：

![03](https://cdn.itbob.cn/img/article/049/03.png)

![04](https://cdn.itbob.cn/img/article/049/04.png)

请求数据和返回数据都经过了加密：

![05](https://cdn.itbob.cn/img/article/049/05.png)
...
![06](https://cdn.itbob.cn/img/article/049/06.png)

![07](https://cdn.itbob.cn/img/article/049/07.png)
...
直接搜索没有值，直接上 Hook 大法，小白朋友不清楚的话可以看以前的文章，都有详细教程，这里不再细说。
...
![08](https://cdn.itbob.cn/img/article/049/08.png)

往上跟栈调试，是一个小小的 OB 混淆，`_0x32e0d2` 就是最后的 `X_HTTP_TOKEN` 值了，如下图所示：

![09](https://cdn.itbob.cn/img/article/049/09.png)
...
![10](https://cdn.itbob.cn/img/article/049/10.png)

补全 document 后，再次运行，又会报错 window 未定义，再次定位到源码，如下图所示：

![11](https://cdn.itbob.cn/img/article/049/11.png)
...
![12](https://cdn.itbob.cn/img/article/049/12.png)

### \_\_lg_stoken\_\_

`__lg_stoken__` 这个参数是在点击搜索后才开始生成的，直接搜索同样没值，Hook 一下，往上跟栈，很容易找到生成位置：

![13](https://cdn.itbob.cn/img/article/049/13.png)

![14](https://cdn.itbob.cn/img/article/049/14.png)
...
![15](https://cdn.itbob.cn/img/article/049/15.png)
...
![16](https://cdn.itbob.cn/img/article/049/16.png)
...
![17](https://cdn.itbob.cn/img/article/049/17.png)
...
![18](https://cdn.itbob.cn/img/article/049/18.png)

本地补齐参数后，运行结果与网页一致：

![19](https://cdn.itbob.cn/img/article/049/19.png)
...
![20](https://cdn.itbob.cn/img/article/049/20.png)
...
![21](https://cdn.itbob.cn/img/article/049/21.png)
...
![22](https://cdn.itbob.cn/img/article/049/22.png)

![23](https://cdn.itbob.cn/img/article/049/23.png)

观察上面的代码，三元表达式，`t.sampled` 为 `true`，所以 `e` 值为 `01`，`n` 值为 `t.id`，重点在于 `t.traceId` 和 `t.id` 了，跟栈发现很难调，直接搜索关键字，可找到生成的位置：

![24](https://cdn.itbob.cn/img/article/049/24.png)

![25](https://cdn.itbob.cn/img/article/049/25.png)
...
![26](https://cdn.itbob.cn/img/article/049/26.png)

这个接口是 post 请求，请求带了一个 json 数据，`secretKeyDecode`，直接搜索关键字，就一个值，定位跟栈：

![27](https://cdn.itbob.cn/img/article/049/27.png)

`zt()` 是从本地缓存中取，`At()` 是重新生成：

![28](https://cdn.itbob.cn/img/article/049/28.png)
...
![29](https://cdn.itbob.cn/img/article/049/29.png)

![30](https://cdn.itbob.cn/img/article/049/30.png)
...
![31](https://cdn.itbob.cn/img/article/049/31.png)

![32](https://cdn.itbob.cn/img/article/049/32.png)
...
![33](https://cdn.itbob.cn/img/article/049/33.png)

## 逆向小技巧

浏览器开发者工具 Application - Storage 选项，可以一键清除所有 Cookies，也可以自定义存储配额：

![34](https://cdn.itbob.cn/img/article/049/34.png)
...
![35](https://cdn.itbob.cn/img/article/049/35.png)
